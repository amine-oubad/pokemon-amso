...
## Layout 320×240 : ville ninja, Centre Pokémon, Pokémart, Arène.
...
func _build_ground() -> void:
	_rect(Vector2.ZERO, Vector2(MAP_W, MAP_H), Color(0.20, 0.30, 0.15))
...
func _build_decor() -> void:
	# Arbres/bambous (vert foncé)
	_rect(Vector2(200, 160), Vector2(100, 60), Color(0.12, 0.25, 0.10, 0.6))
	_rect(Vector2(16, 16), Vector2(80, 60), Color(0.12, 0.25, 0.10, 0.6))
...
func _build_buildings() -> void:
	...
	_building(Vector2(200.0, 8.0), Vector2(112.0, 56.0), Color(0.40, 0.18, 0.50), "ARÈNE DE\nPARMANIE")

func _build_borders() -> void:
	_wall(Vector2(-8.0, MAP_H * 0.5), Vector2(16.0, MAP_H + 16.0))
	# Est wall — gap for Route 8
...
func _build_npcs() -> void:
	_npc(Vector2(56.0, 184.0), "fuchsia_npc1", "heal_team", "",       Color(0.90, 0.70, 0.70))
	_npc(Vector2(56.0, 230.0), "",             "open_shop", "fuchsia_shop", Color(0.30, 0.65, 0.30))
	_npc(Vector2(120.0, 200.0), "fuchsia_npc2", "",         "",       Color(0.50, 0.30, 0.50))
	_npc(Vector2(260.0, 200.0), "fuchsia_npc3", "",         "",       Color(0.40, 0.55, 0.35))

func _build_signs() -> void:
	_sign(Vector2(144.0, 200.0), "fuchsia_sign1")
...
func _on_battle_started(enemy_data: Dictionary, is_trainer: bool) -> void:
	...
	GameState.return_to_scene = "res://scenes/overworld/maps/FuchsiaCity.tscn"
