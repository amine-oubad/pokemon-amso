...
func _build_encounter_zones() -> void:
	_encounter_zone(Vector2(138.0, 120.0), Vector2(180.0, 240.0), "route5", "grass_01", 0.15)
	_encounter_zone(Vector2(350.0, 120.0), Vector2(160.0, 240.0), "route5", "grass_02", 0.15)
